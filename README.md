...
You can use `scripts/plot_regret_total.py` to plot regret curves for all considered S's.

```
usage: plot_regret_total.py [-h] [-d [D]] [-hz [HZ]] [-ast [AST]]
...
<img src="./regret_fig.png" width="600" alt="">
