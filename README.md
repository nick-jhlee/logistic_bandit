Code for the following two papers:
- [_A Unified Confidence Sequence for Generalized Linear Models, with Applications to Bandits_](https://arxiv.org/abs/2407.13977) (arXiv 2024), by [Junghyun Lee](https://nick-jhlee.github.io/), [Se-Young Yun](https://fbsqkd.github.io/), and [Kwang-Sung Jun](https://kwangsungjun.github.io).
- [_Improved Regret Bounds of (Multinomial) Logistic Bandits via Regret-to-Confidence-Set Conversion_](https://arxiv.org/abs/2310.18554) (AISTATS 2024), by [Junghyun Lee](https://nick-jhlee.github.io/), [Se-Young Yun](https://fbsqkd.github.io/), and [Kwang-Sung Jun](https://kwangsungjun.github.io).
...
This code implements the `OFULog+` of [Lee et al. 2024](https://arxiv.org/abs/2310.18554) and `OFUGLB` & `OFUGLB-e` of [Lee et al. 2024](https://arxiv.org/abs/2407.13977), along with several baselines (oldest to newest):
